...
public class Administrador extends Usuario{
    ...
    public Administrador(String idusuario, String nombre, String apellido, String email, String contraseña,String clave) {
    ...
    public Administrador buscarAdmin(String id){
        for (Administrador admin : admins) {
            if(admin.getId_usuario().equals(id)){
                return admin;
            }
        }
        return null;
    ...
    public boolean verificaContraseña(String id,String contraseña){
        for (Administrador admin : admins) {
            if(admin.getContraseña().equals(contraseña) && admin.getId_usuario().equals(id)){
                return true;
            }
        }
        return false;
